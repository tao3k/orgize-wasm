...
export class Org {
    ...
    format(request_json?: string | null): string;
    html(): string;
...
export interface InitOutput {
    ...
    readonly org_format: (a: number, b: number, c: number) => [number, number, number, number];
    ...
    readonly org_replaceRange: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    ...
    readonly org_sourceLenBytes: (a: number) => number;
