...
export const org_attachmentInventoryJson: (a: number, b: number, c: number) => [number, number, number, number];
...
export const org_format: (a: number, b: number, c: number) => [number, number, number, number];
...
export const org_memoryJson: (a: number, b: number, c: number) => [number, number, number, number];
export const org_metadataJson: (a: number) => [number, number];
export const org_org: (a: number) => [number, number];
export const org_orgElementsIndexJson: (a: number) => [number, number];
export const org_orgElementsIndexQueryJson: (a: number, b: number, c: number) => [number, number, number, number];
...
export const org_replaceRange: (a: number, b: number, c: number, d: number, e: number) => [number, number];
...
export const org_sourceLenBytes: (a: number) => number;
...
export const org_orgInteractiveJson: (a: number) => [number, number, number, number];
